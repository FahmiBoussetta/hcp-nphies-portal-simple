...
import com.platformsandsolutions.hcpnphiesportalsimple.repository.NoteRepository;
...
/**
 * REST controller for managing {@link com.platformsandsolutions.hcpnphiesportalsimple.domain.Note}.
 */
@RestController
@RequestMapping("/api")
@Transactional
