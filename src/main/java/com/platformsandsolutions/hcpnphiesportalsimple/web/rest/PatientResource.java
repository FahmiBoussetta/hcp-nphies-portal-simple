...
/**
 * REST controller for managing {@link com.platformsandsolutions.hcpnphiesportalsimple.domain.Patient}.
 */
@RestController
@RequestMapping("/api")
@Transactional
            ...
            .map(
                existingPatient -> {
                    ...
                    if (patient.getStart() != null) {
                        existingPatient.setStart(patient.getStart());
                    }
                    if (patient.getEnd() != null) {
                        existingPatient.setEnd(patient.getEnd());
                    }
