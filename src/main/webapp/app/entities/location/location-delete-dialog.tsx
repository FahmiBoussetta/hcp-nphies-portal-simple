...
export const LocationDeleteDialog = (props: ILocationDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalSimpleApp.location.delete.question">
        <Translate contentKey="hcpNphiesPortalSimpleApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
