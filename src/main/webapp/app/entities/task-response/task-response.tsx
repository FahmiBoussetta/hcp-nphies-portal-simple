  ...
  return (
    <div>
      <h2 id="task-response-heading" data-cy="TaskResponseHeading">
        <Translate contentKey="hcpNphiesPortalSimpleApp.taskResponse.home.title">Task Responses</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="hcpNphiesPortalSimpleApp.taskResponse.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="hcpNphiesPortalSimpleApp.taskResponse.home.createLabel">Create new Task Response</Translate>
          </Link>
        </div>
      </h2>
        ...
        {taskResponseList && taskResponseList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="hcpNphiesPortalSimpleApp.taskResponse.id">ID</Translate>
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="hcpNphiesPortalSimpleApp.taskResponse.home.notFound">No Task Responses found</Translate>
            </div>
          )
        )}
      </div>
