...
export const HospitalizationDeleteDialog = (props: IHospitalizationDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalSimpleApp.hospitalization.delete.question">
        <Translate contentKey="hcpNphiesPortalSimpleApp.hospitalization.delete.question" interpolate={{ id: hospitalizationEntity.id }}>
