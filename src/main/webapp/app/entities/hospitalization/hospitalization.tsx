  ...
  return (
    <div>
      <h2 id="hospitalization-heading" data-cy="HospitalizationHeading">
        <Translate contentKey="hcpNphiesPortalSimpleApp.hospitalization.home.title">Hospitalizations</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="hcpNphiesPortalSimpleApp.hospitalization.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="hcpNphiesPortalSimpleApp.hospitalization.home.createLabel">Create new Hospitalization</Translate>
          </Link>
        </div>
      </h2>
        ...
        {hospitalizationList && hospitalizationList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="hcpNphiesPortalSimpleApp.hospitalization.id">ID</Translate>
                </th>
                <th>
            ...
            <tbody>
              {hospitalizationList.map((hospitalization, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`hcpNphiesPortalSimpleApp.AdmitSourceEnum.${hospitalization.admitSource}`} />
                  </td>
                  <td>
                    <Translate contentKey={`hcpNphiesPortalSimpleApp.ReAdmissionEnum.${hospitalization.reAdmission}`} />
                  </td>
                  <td>
                    <Translate contentKey={`hcpNphiesPortalSimpleApp.DischargeDispositionEnum.${hospitalization.dischargeDisposition}`} />
                  </td>
                  <td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="hcpNphiesPortalSimpleApp.hospitalization.home.notFound">No Hospitalizations found</Translate>
            </div>
          )
        )}
      </div>
