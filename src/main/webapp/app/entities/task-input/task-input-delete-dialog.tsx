...
export const TaskInputDeleteDialog = (props: ITaskInputDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalSimpleApp.taskInput.delete.question">
        <Translate contentKey="hcpNphiesPortalSimpleApp.taskInput.delete.question" interpolate={{ id: taskInputEntity.id }}>
