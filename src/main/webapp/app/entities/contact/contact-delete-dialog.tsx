...
export const ContactDeleteDialog = (props: IContactDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalSimpleApp.contact.delete.question">
        <Translate contentKey="hcpNphiesPortalSimpleApp.contact.delete.question" interpolate={{ id: contactEntity.id }}>
