...
export const ExemptionComponentDeleteDialog = (props: IExemptionComponentDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalSimpleApp.exemptionComponent.delete.question">
        <Translate
          contentKey="hcpNphiesPortalSimpleApp.exemptionComponent.delete.question"
          interpolate={{ id: exemptionComponentEntity.id }}
        >
