...
export const AttachmentDeleteDialog = (props: IAttachmentDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalSimpleApp.attachment.delete.question">
        <Translate contentKey="hcpNphiesPortalSimpleApp.attachment.delete.question" interpolate={{ id: attachmentEntity.id }}>
