...
export const OrganizationDeleteDialog = (props: IOrganizationDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalSimpleApp.organization.delete.question">
        <Translate contentKey="hcpNphiesPortalSimpleApp.organization.delete.question" interpolate={{ id: organizationEntity.id }}>
