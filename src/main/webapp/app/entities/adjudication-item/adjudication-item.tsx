  ...
  return (
    <div>
      <h2 id="adjudication-item-heading" data-cy="AdjudicationItemHeading">
        <Translate contentKey="hcpNphiesPortalSimpleApp.adjudicationItem.home.title">Adjudication Items</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="hcpNphiesPortalSimpleApp.adjudicationItem.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="hcpNphiesPortalSimpleApp.adjudicationItem.home.createLabel">Create new Adjudication Item</Translate>
          </Link>
        </div>
      </h2>
        ...
        {adjudicationItemList && adjudicationItemList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="hcpNphiesPortalSimpleApp.adjudicationItem.id">ID</Translate>
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="hcpNphiesPortalSimpleApp.adjudicationItem.home.notFound">No Adjudication Items found</Translate>
            </div>
          )
        )}
      </div>
