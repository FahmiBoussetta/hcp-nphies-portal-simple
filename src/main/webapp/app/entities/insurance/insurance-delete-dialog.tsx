...
export const InsuranceDeleteDialog = (props: IInsuranceDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalSimpleApp.insurance.delete.question">
        <Translate contentKey="hcpNphiesPortalSimpleApp.insurance.delete.question" interpolate={{ id: insuranceEntity.id }}>
