...
export const QuantityDeleteDialog = (props: IQuantityDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalSimpleApp.quantity.delete.question">
        <Translate contentKey="hcpNphiesPortalSimpleApp.quantity.delete.question" interpolate={{ id: quantityEntity.id }}>
