...
export const AddressDeleteDialog = (props: IAddressDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalSimpleApp.address.delete.question">
        <Translate contentKey="hcpNphiesPortalSimpleApp.address.delete.question" interpolate={{ id: addressEntity.id }}>
