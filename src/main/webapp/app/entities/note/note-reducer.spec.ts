...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          REQUEST(ACTION_TYPES.CREATE_NOTE),
          REQUEST(ACTION_TYPES.UPDATE_NOTE),
          REQUEST(ACTION_TYPES.PARTIAL_UPDATE_NOTE),
          REQUEST(ACTION_TYPES.DELETE_NOTE),
        ],
        {},
        state => {
          expect(state).toMatchObject({
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.PARTIAL_UPDATE_NOTE),
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.PARTIAL_UPDATE_NOTE actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.PARTIAL_UPDATE_NOTE),
        },
        {
          type: SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_NOTE),
          payload: resolvedObject,
        },
      ];
