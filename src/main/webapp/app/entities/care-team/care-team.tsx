  ...
  return (
    <div>
      <h2 id="care-team-heading" data-cy="CareTeamHeading">
        <Translate contentKey="hcpNphiesPortalSimpleApp.careTeam.home.title">Care Teams</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="hcpNphiesPortalSimpleApp.careTeam.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="hcpNphiesPortalSimpleApp.careTeam.home.createLabel">Create new Care Team</Translate>
          </Link>
        </div>
      </h2>
        ...
        {careTeamList && careTeamList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="hcpNphiesPortalSimpleApp.careTeam.id">ID</Translate>
                </th>
                <th>
            ...
            <tbody>
              {careTeamList.map((careTeam, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`hcpNphiesPortalSimpleApp.CareTeamRoleEnum.${careTeam.role}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="hcpNphiesPortalSimpleApp.careTeam.home.notFound">No Care Teams found</Translate>
            </div>
          )
        )}
      </div>
