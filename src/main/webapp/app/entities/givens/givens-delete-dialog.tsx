...
export const GivensDeleteDialog = (props: IGivensDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalSimpleApp.givens.delete.question">
        <Translate contentKey="hcpNphiesPortalSimpleApp.givens.delete.question" interpolate={{ id: givensEntity.id }}>
