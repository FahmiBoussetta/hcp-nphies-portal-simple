...
export const OperationOutcomeDeleteDialog = (props: IOperationOutcomeDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalSimpleApp.operationOutcome.delete.question">
        <Translate contentKey="hcpNphiesPortalSimpleApp.operationOutcome.delete.question" interpolate={{ id: operationOutcomeEntity.id }}>
