  ...
  return (
    <div>
      <h2 id="operation-outcome-heading" data-cy="OperationOutcomeHeading">
        <Translate contentKey="hcpNphiesPortalSimpleApp.operationOutcome.home.title">Operation Outcomes</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="hcpNphiesPortalSimpleApp.operationOutcome.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="hcpNphiesPortalSimpleApp.operationOutcome.home.createLabel">Create new Operation Outcome</Translate>
          </Link>
        </div>
      </h2>
        ...
        {operationOutcomeList && operationOutcomeList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="hcpNphiesPortalSimpleApp.operationOutcome.id">ID</Translate>
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="hcpNphiesPortalSimpleApp.operationOutcome.home.notFound">No Operation Outcomes found</Translate>
            </div>
          )
        )}
      </div>
