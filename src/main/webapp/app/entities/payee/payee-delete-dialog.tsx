...
export const PayeeDeleteDialog = (props: IPayeeDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalSimpleApp.payee.delete.question">
        <Translate contentKey="hcpNphiesPortalSimpleApp.payee.delete.question" interpolate={{ id: payeeEntity.id }}>
