...
export const InformationSequenceDeleteDialog = (props: IInformationSequenceDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalSimpleApp.informationSequence.delete.question">
        <Translate
          contentKey="hcpNphiesPortalSimpleApp.informationSequence.delete.question"
          interpolate={{ id: informationSequenceEntity.id }}
        >
