...
export const TaskDeleteDialog = (props: ITaskDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalSimpleApp.task.delete.question">
        <Translate contentKey="hcpNphiesPortalSimpleApp.task.delete.question" interpolate={{ id: taskEntity.id }}>
