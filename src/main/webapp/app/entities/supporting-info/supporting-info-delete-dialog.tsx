...
export const SupportingInfoDeleteDialog = (props: ISupportingInfoDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalSimpleApp.supportingInfo.delete.question">
        <Translate contentKey="hcpNphiesPortalSimpleApp.supportingInfo.delete.question" interpolate={{ id: supportingInfoEntity.id }}>
