...
export const ItemDeleteDialog = (props: IItemDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalSimpleApp.item.delete.question">
        <Translate contentKey="hcpNphiesPortalSimpleApp.item.delete.question" interpolate={{ id: itemEntity.id }}>
