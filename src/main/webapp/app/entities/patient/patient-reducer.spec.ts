...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          REQUEST(ACTION_TYPES.CREATE_PATIENT),
          REQUEST(ACTION_TYPES.UPDATE_PATIENT),
          REQUEST(ACTION_TYPES.PARTIAL_UPDATE_PATIENT),
          REQUEST(ACTION_TYPES.DELETE_PATIENT),
        ],
        {},
        state => {
          expect(state).toMatchObject({
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.PARTIAL_UPDATE_PATIENT),
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.PARTIAL_UPDATE_PATIENT actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.PARTIAL_UPDATE_PATIENT),
        },
        {
          type: SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_PATIENT),
          payload: resolvedObject,
        },
      ];
