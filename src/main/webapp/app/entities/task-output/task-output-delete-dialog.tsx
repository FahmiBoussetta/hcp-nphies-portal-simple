...
export const TaskOutputDeleteDialog = (props: ITaskOutputDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalSimpleApp.taskOutput.delete.question">
        <Translate contentKey="hcpNphiesPortalSimpleApp.taskOutput.delete.question" interpolate={{ id: taskOutputEntity.id }}>
