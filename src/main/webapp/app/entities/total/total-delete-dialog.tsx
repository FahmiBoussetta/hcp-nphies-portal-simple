...
export const TotalDeleteDialog = (props: ITotalDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalSimpleApp.total.delete.question">
        <Translate contentKey="hcpNphiesPortalSimpleApp.total.delete.question" interpolate={{ id: totalEntity.id }}>
