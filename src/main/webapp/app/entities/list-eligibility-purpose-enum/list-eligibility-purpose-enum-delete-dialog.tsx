...
export const ListEligibilityPurposeEnumDeleteDialog = (props: IListEligibilityPurposeEnumDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalSimpleApp.listEligibilityPurposeEnum.delete.question">
        <Translate
          contentKey="hcpNphiesPortalSimpleApp.listEligibilityPurposeEnum.delete.question"
