...
export const PractitionerDeleteDialog = (props: IPractitionerDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalSimpleApp.practitioner.delete.question">
        <Translate contentKey="hcpNphiesPortalSimpleApp.practitioner.delete.question" interpolate={{ id: practitionerEntity.id }}>
