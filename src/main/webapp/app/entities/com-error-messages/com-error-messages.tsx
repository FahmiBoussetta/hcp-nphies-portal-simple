  ...
  return (
    <div>
      <h2 id="com-error-messages-heading" data-cy="ComErrorMessagesHeading">
        <Translate contentKey="hcpNphiesPortalSimpleApp.comErrorMessages.home.title">Com Error Messages</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="hcpNphiesPortalSimpleApp.comErrorMessages.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="hcpNphiesPortalSimpleApp.comErrorMessages.home.createLabel">Create new Com Error Messages</Translate>
          </Link>
        </div>
      </h2>
        ...
        {comErrorMessagesList && comErrorMessagesList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="hcpNphiesPortalSimpleApp.comErrorMessages.id">ID</Translate>
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="hcpNphiesPortalSimpleApp.comErrorMessages.home.notFound">No Com Error Messages found</Translate>
            </div>
          )
        )}
      </div>
