...
export const ComErrorMessagesDeleteDialog = (props: IComErrorMessagesDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hcpNphiesPortalSimpleApp.comErrorMessages.delete.question">
        <Translate contentKey="hcpNphiesPortalSimpleApp.comErrorMessages.delete.question" interpolate={{ id: comErrorMessagesEntity.id }}>
