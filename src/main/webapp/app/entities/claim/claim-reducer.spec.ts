...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          REQUEST(ACTION_TYPES.CREATE_CLAIM),
          REQUEST(ACTION_TYPES.UPDATE_CLAIM),
          REQUEST(ACTION_TYPES.PARTIAL_UPDATE_CLAIM),
          REQUEST(ACTION_TYPES.DELETE_CLAIM),
        ],
        {},
        state => {
          expect(state).toMatchObject({
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.PARTIAL_UPDATE_CLAIM),
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.PARTIAL_UPDATE_CLAIM actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.PARTIAL_UPDATE_CLAIM),
        },
        {
          type: SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_CLAIM),
          payload: resolvedObject,
        },
      ];
